This repository goes alongside a [blog post](http://stephenmann.io/post/how-to-setup-flow-with-create-react-app-and-visual-studio-code/) about setting up create-react-app with Flow. 
